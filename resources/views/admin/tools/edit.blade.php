...
@section('title', 'ØªØ¹Ø¯ÙŠÙ„ Ø£Ø¯Ø§Ø© Ø§Ù„Ø´ÙŠÙ - Ù„ÙˆØ­Ø© Ø§Ù„Ø¥Ø¯Ø§Ø±Ø©')
    ...
    <div class="admin-card text-white py-8">
        <div class="container mx-auto px-4">
            <div class="flex items-center">
                ...
                <div>
                    <h1 class="text-3xl font-bold mb-2">ØªØ¹Ø¯ÙŠÙ„ Ø£Ø¯Ø§Ø© Ø§Ù„Ø´ÙŠÙ</h1>
                ...
                <form action="{{ route('admin.tools.update', $tool) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
                        ...
                        <div class="space-y-6">
                            ...
                            @if($tool->image)
                                <div>
                                    <label class="block text-sm font-semibold text-gray-700 mb-2">Ø§Ù„ØµÙˆØ±Ø© Ø§Ù„Ø­Ø§Ù„ÙŠØ©</label>
                            ...
                            <div>
                                <label for="image" class="block text-sm font-semibold text-gray-700 mb-2">
                                    {{ $tool->image ? 'ØªØºÙŠÙŠØ± Ø§Ù„ØµÙˆØ±Ø©' : 'ØµÙˆØ±Ø© Ø§Ù„Ø£Ø¯Ø§Ø©' }}
                                </label>
                                <input type="file" 
                                       id="image" 
                                       name="image" 
                            ...
                            <div>
                                ...
                                <input type="url" 
                                       id="affiliate_url" 
                                       name="affiliate_url" 
                                       value="{{ old('affiliate_url', $tool->affiliate_url) }}"
