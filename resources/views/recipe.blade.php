...
@push('styles')
    <style>
      .serving-size-btn.bg-orange-500 {
        background-color: #6b2e30 !important;
      }
      ...
      .video-shell {
        ...
        overflow: hidden;
        background: radial-gradient(circle at 20% 20%, rgba(107, 46, 48, 0.12), transparent 45%), #0b1c2d;
      ...
      .star-rating input:checked ~ label .star {
        color: #9f5e63 !important;
        transform: scale(1.1);
        text-shadow: 0 2px 4px rgba(143, 74, 80, 0.3);
      }
      ...
      .btn.save-recipe-btn.bg-orange-500 {
        background-color: #6b2e30 !important; /* bg-orange-500 */
      }
  
      .btn.save-recipe-btn.bg-orange-500:hover {
        background-color: #7f3a3d !important; /* hover:bg-orange-600 */
      }
      ...
      .recipe-hero {
        position: relative;
        background: linear-gradient(135deg, rgba(232, 242, 255, 0.85) 0%, rgba(244, 246, 255, 0.92) 45%, #ffffff 100%);
      ...
      .recipe-hero::after {
        ...
        background: radial-gradient(circle at center, rgba(107, 46, 48, 0.18), transparent 65%);
        pointer-events: none;
      ...
      .hero-stat {
        ...
        box-shadow: 0 12px 30px rgba(107, 46, 48, 0.08);
      }
      ...
      .hero-panel {
        ...
        border: 1px solid rgba(107, 46, 48, 0.15);
        border-radius: 1.5rem;
      ...
      .section-card {
        position: relative;
        background: linear-gradient(160deg, rgba(255, 255, 255, 0.96) 0%, rgba(244, 246, 255, 0.75) 80%, #ffffff 100%);
        border-radius: 1.5rem;
        padding: 2rem;
        border: 1px solid rgba(107, 46, 48, 0.12);
      ...
      .serving-size-btn:hover {
        ...
        box-shadow: 0 10px 24px rgba(107, 46, 48, 0.15);
      }
      ...
      .serving-size-hint {
        ...
        border-radius: 1rem;
        background: rgba(255, 255, 255, 0.9);
        border: 1px dashed rgba(107, 46, 48, 0.3);
      }
      ...
      .step-number {
        ...
        font-size: 1.1rem;
        flex-shrink: 0;
        box-shadow: 0 12px 24px rgba(107, 46, 48, 0.3);
      }
      ...
      .callout-card {
        ...
        gap: 1.5rem;
        background: linear-gradient(140deg, rgba(107, 46, 48, 0.12) 0%, rgba(143, 74, 80, 0.08) 45%, rgba(255, 255, 255, 0.85) 100%);
        border: 1px solid rgba(107, 46, 48, 0.14);
      }
      ...
      .origin-badge.origin-creator { background: rgba(143, 74, 80, 0.12); border-color: rgba(143, 74, 80, 0.28); color: #0a8f78; }
      .origin-badge.origin-partner { background: rgba(247, 201, 72, 0.12); border-color: rgba(247, 201, 72, 0.28); color: #c47a00; }
      .origin-badge.origin-peah { background: rgba(107, 46, 48, 0.1); border-color: rgba(107, 46, 48, 0.28); color: #6b2e30; }
      ...
      .workshop-cta {
        ...
        border-radius: 1.5rem;
        background: linear-gradient(120deg, rgba(107, 46, 48, 0.12), rgba(143, 74, 80, 0.12));
        border: 1px solid rgba(107, 46, 48, 0.12);
        box-shadow: 0 18px 40px rgba(107, 46, 48, 0.08);
        display: grid;
      ...
      .workshop-cta__eyebrow {
        ...
        border-radius: 999px;
        background: rgba(143, 74, 80, 0.14);
        color: #0b8c78;
        font-weight: 800;
        margin-bottom: 0.35rem;
      }
      ...
      .workshop-secondary {
        background: rgba(107, 46, 48, 0.06);
        color: #6b2e30;
      ...
      .callout-badge {
        ...
        border-radius: 9999px;
        background: rgba(255, 255, 255, 0.9);
        border: 1px solid rgba(107, 46, 48, 0.3);
        color: #6b2e30;
        font-weight: 700;
        font-size: 0.9rem;
      }
      ...
      @media print {
        ...
        h1 {
          ...
          text-align: center;
          margin-bottom: 20px;
          border-bottom: 3px solid #6b2e30;
          padding-bottom: 15px;
        }
      ...
      .tool-card::before {
        ...
        right: 0;
        height: 3px;
        background: linear-gradient(90deg, #6b2e30, #9f5e63, #9f5e63);
      }
      
      .tool-card:hover {
        transform: translateY(-2px);
        box-shadow: 0 10px 25px rgba(107, 46, 48, 0.15);
        border-color: #6b2e30;
      }
      ...
      .tool-icon {
        ...
        justify-content: center;
        margin: 0 auto 1rem;
        box-shadow: 0 4px 12px rgba(107, 46, 48, 0.3);
      }
      ...
      .tool-divider {
        width: 2rem;
        height: 3px;
        background: linear-gradient(90deg, #6b2e30, #9f5e63);
        border-radius: 2px;
        margin: 0 auto;
      }
      ...
      .related-recipe-card .recipe-image::after {
        ...
        right: 0;
        bottom: 0;
        background: linear-gradient(45deg, transparent 0%, rgba(107, 46, 48, 0.1) 100%);
        opacity: 0;
      ...
      .related-recipe-card .category-badge {
        background: linear-gradient(135deg, #f1d8da 0%, #9f5e63 100%);
        color: #4d1f22;
        font-weight: 600;
        text-shadow: 0 1px 2px rgba(255, 255, 255, 0.3);
        box-shadow: 0 2px 4px rgba(107, 46, 48, 0.2);
      }
            ...
            function initializeRatingScroll() {
                ...
                if (ratingScrollBtn && ratingSection) {
                    ratingScrollBtn.addEventListener('click', function(e) {
                        ...
                        ratingSection.style.boxShadow = '0 0 20px rgba(107, 46, 48, 0.3)';
