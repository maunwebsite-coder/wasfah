...
return [
    ...
    'hero' => [
        ...
        'secondary_cta' => 'Explore the benefits',
    ],
    'stats' => [
        [
            'icon' => 'fas fa-lightbulb',
            'value' => '15%',
            'label' => 'Top commission tier based on campaigns',
        ],
        [
    ...
    'cta' => [
        ...
        'steps' => [
            [
                ...
                'description' => 'Send your details via the contact page and specify your desired collaboration type.',
            ],
            [
                'title' => 'Receive your link & dashboard',
                'description' => 'We will send your unique link, login credentials, and usage guide within three business days.',
            ],
            [
    ...
    'guidance' => [
        ...
        'description' => 'Fill out the details below and your message will reach the dedicated team instantly. We typically respond within one business day and share the activation steps for the partner dashboard.',
        'bullets' => [
            'Choose the collaboration type that suits you and tell us about your target audience.',
            'Once received, your request appears in the admin dashboard to track status and next steps.',
            'You will get an email notification when the team reviews your request or asks for additional documents.',
        ],
        'note' => 'We review submissions twice a day and every request status is updated instantly inside the admin area.',
    ],
    'form' => [
        'heading' => 'Partnership application form',
        'description' => 'Send your information to receive the admin link and tracking dashboard. We will notify you once the request is logged by the partnerships team.',
        'fields' => [
            'first_name' => [
                'label' => 'First name',
            ...
            'phone' => [
                ...
                'placeholder' => 'Add your phone number for follow-up (optional)',
            ],
            'subject' => [
                'label' => 'Subject',
                'placeholder' => 'Partnership or collaboration request',
            ],
            'message' => [
                'label' => 'Message',
