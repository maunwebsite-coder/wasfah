...
return [
    ...
    'cards' => [
        ...
        'buttons' => [
            ...
            'amazon' => 'Continue checkout on Amazon',
            'save' => 'Save to buy later',
            'saved' => 'Saved',
            'saving' => 'Saving...',
    ...
    'notifications' => [
        'saved' => 'Product saved for later!',
        'save_error' => 'Something went wrong while saving the product',
        'removed' => 'Product removed from saved items!',
        'remove_error' => 'An error occurred while removing the product',
